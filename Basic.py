...
# Creating a Title
st.title("Hello Welcome to Creative IT !!!")
...
# Markdown
st.markdown("### This is a markdown sample ")
...
# Writing a sample python function
st.write(range(10))
...
with st.sidebar:
    st.write("Hello I am information in side a sidebar")